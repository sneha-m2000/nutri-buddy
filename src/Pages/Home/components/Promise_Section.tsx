...
const leftVariants: Variants = {
    ...
    visible: {
        opacity: 1,
        x: 0,
        transition: { duration: 0.6, ease: [0.22, 1, 0.36, 1] }, // cubic-bezier array
    },
    exit: {
        opacity: 0,
        x: -40,
            ...
            <div className="max-w-7xl mx-auto">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <motion.div
                        ...
                        className="ml-12 h-full"
                    >
                        <h3 className="text-[#5fb8a6]  text-center font-heading text-lg font-semibold tracking-wider uppercase mb-4">
                            OUR PROMISE
                        </h3>
                        <h2 className="text-4xl md:text-5xl text-[#006666]  text-center font-body font-bold mb-12">
                            Hygienic, Fresh & Fast
                        </h2>
                        ...
                        <div className="grid sm:grid-cols-2 gap-8">
                            {features.map((feature, index) => (
                                <div key={index} className="space-y-3">
                                    <div className="text-[#66b2b2] font-body ">{feature.icon}</div>
                                    <h4 className="text-lg font-semibold font-body ">{feature.title}</h4>
                    ...
                    <motion.div
                        ...
                        className="flex justify-center lg:justify-end h-full"
                    >
                        {/* use motion.img so the image itself can animate */}
                        <motion.img
                            src={promiseImg}
                            alt="Promise Section Image"
                            className="w-full h-full max-w-md rounded-2xl object-contain shadow-xl mr-12"
                            // optional: add a tiny scale up on visible for polish
